...
//
//class RelatedAdViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
//
//
//    var postId = ""
...
//        }else{
//
//            let alert = UIAlertController(title: "Zoolife", message:"يجب عليك تسجيل الدخول", preferredStyle: UIAlertController.Style.alert)
//            alert.addAction(UIAlertAction(title: Okey(), style: UIAlertAction.Style.default, handler: nil))
//            self.present(alert, animated: true, completion: nil)
//            return
//        }
...
//    {
//        let receiver:User = User(ID: post?.fromUserId, fullname: post?.username, email: post?.email, phone: post?.phoneNumber, avatar: post?.itemImage,msg_badge: "",noti_badge: "")
//
...
//
//            let phoneNumber =  "+966\(phone)" // you need to change this number
...
//
//
//extension RelatedAdViewController{
//
...
//                let viewController = RelatedAdViewController()
...
//        if collectionView == relatedCollectionViewAds{
//            let width = (relatedCollectionViewAds.frame.size.width-30)/3
